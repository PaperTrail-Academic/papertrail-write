...
.status-msg.warning { background: #fff8e1; border: 1px solid #f0c040; color: #7a4f00; display: block; }
...
.auth-wordmark-icon { width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
...
.landing-wordmark-icon { width: 36px; height: 36px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
...
.landing-links { display: flex; gap: 0.75rem; justify-content: center; flex-wrap: wrap; margin-top: 2rem; margin-bottom: 0.5rem; }
.landing-link-btn { font-family: 'DM Sans', sans-serif; font-size: var(--text-sm); font-weight: 500; padding: 0.45rem 1.1rem; border-radius: 999px; text-decoration: none; transition: background 0.15s, color 0.15s; }
.landing-link-video { background: rgba(255,255,255,0.12); color: rgba(255,255,255,0.85); border: 1px solid rgba(255,255,255,0.2); }
.landing-link-video:hover { background: rgba(255,255,255,0.2); color: #fff; }
.landing-link-site { background: transparent; color: rgba(255,255,255,0.55); border: 1px solid rgba(255,255,255,0.15); }
.landing-link-site:hover { background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.85); }
.landing-legal { font-size: 11px; color: rgba(255,255,255,0.25); margin-top: 2rem; line-height: 1.6; }
.landing-legal a { color: rgba(255,255,255,0.4); text-decoration: underline; }
.landing-legal a:hover { color: rgba(255,255,255,0.7); }
...
.autosave-indicator.error  { color: #f87171; font-weight: 600; }
...
.dash-brand-icon { width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
...
.btn-drive-picker:disabled, .btn-drive-coming-soon { opacity: 0.55; cursor: not-allowed; }
.btn-drive-coming-soon:hover { border-color: var(--pt-border) !important; color: var(--pt-muted) !important; background: none !important; }
.drive-coming-soon-badge { font-size: 0.65rem; background: var(--pt-light); color: var(--pt-muted); border-radius: 3px; padding: 0.1rem 0.35rem; margin-left: 0.15rem; font-weight: 500; letter-spacing: 0.02em; }
.source-file-divider { display: flex; align-items: center; gap: 0.5rem; margin: 0.6rem 0; color: var(--pt-muted); font-size: var(--text-xs); }
.source-file-divider::before, .source-file-divider::after { content: ''; flex: 1; height: 1px; background: var(--pt-border); }
.source-file-hint { font-size: var(--text-xs); color: var(--pt-muted); margin-top: 0.4rem; }
...
.onboarding-video-link:hover { text-decoration: underline; }
...
.pt-tooltip-popover {
  ...
  max-width: 280px;
  background: var(--pt-write-pale);
  border: 1px solid var(--pt-write-l);
  border-radius: var(--radius-md);
...
.pt-help-video-link:hover { text-decoration: underline; }
...
.asgn-collapsed-header:hover {
  background: var(--pt-write-pale);
}

/* Single row: chevron + title stack + status pill */
.asgn-collapsed-top {
  display: flex;
  align-items: center;
  gap: 0.5rem;
...
.asgn-chevron.asgn-chevron-open {
  transform: rotate(90deg);
}

/* Title + class name stacked */
.asgn-collapsed-titles {
  display: flex;
  flex-direction: column;
  gap: 0.1rem;
  min-width: 0;
...
/* Status pill + join code — own row below title when expanded */
.asgn-header-status {
  display: flex;
  align-items: center;
  gap: 0.4rem;
  flex-wrap: wrap;
  padding-left: 1.6rem; /* align under title, past chevron */
  margin-top: 0.35rem;
}

/* Fully collapsed card */
.assignment-item.asgn-collapsed {
  padding: 0;
}
...
/* When expanded, header has a bottom border separating it from the body */
.assignment-item:not(.asgn-collapsed) {
  padding: 0;
}
.assignment-item:not(.asgn-collapsed) .asgn-collapsed-header {
  border-bottom: 1px solid var(--pt-write-l);
  border-radius: var(--radius-sm) var(--radius-sm) 0 0;
}

/* Action button rows — even spacing */
...
.assignment-actions-primary .btn {
  flex: 1;
  justify-content: center;
  text-align: center;
}
